...
_Python processes about 100x more samples than C:_
- Python: 157,286,400
- C: 1,572,864

_So direct total runtime (39.5 s vs 0.126 s) overstates C speedup._
...
_Inference: C is about 3.14x faster in end-to-end throughput under current settings._
...
_Inference: C runtime cost per sample is about 3.14x lower._
...
_A good acceptance target for parity is absolute error under about 0.5 dB for noise/center/SNR means on the same sample slices._
