...
**Version:** 0.2.0-dev | **Objective:** Improve RF signal quality through systematic calibration and anomaly detection across 11 distributed sensors.
...
### 1. **SENSOR CALIBRATION (Calibrar Sensores)**
...
### 2. **QUALITY EMISSIONS (RF) (Calidad de Emisiones)**
...
### 3. **SIGNAL PROCESSING ALGORITHMS (Algoritmos para Adquisición SDR)**
...
### 4. **IQ DISTORTION HANDLING (Distorsión IQ)**
...
### 5. **BETTER ACQUISITION CONDITIONS (Mejores Condiciones de Adquisición)**
